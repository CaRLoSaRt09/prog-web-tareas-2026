...
import { MatSelectModule } from '@angular/material/select'; //! Se agrego esto 
...
@Component({
  ...
  imports: [
    ...
    MatButtonModule,
    MatIconModule,
    MatSelectModule //! Se agrego esto
  ],
  template: `
...
export class FormularioContactoComponent {
  ...
  guardar(): void {
    ...
    const nuevoContacto: ContactoCreate = {
      ...
      categoria: this.categoria.trim() //! Esto se agrego
    };
