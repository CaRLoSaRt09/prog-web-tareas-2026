...
import { MatChipsModule } from '@angular/material/chips'; //! Se agregi esti 
  ...
  template: `
    <mat-card class="section-card">
      <mat-card-content>
        ...
        <mat-chip-set aria-label="Selección de categorías">
            <mat-chip 
              [highlighted]="categoriaActiva() === 'todos'" 
              color="primary"
              (click)="filtrar('todos')">
              Todos
            </mat-chip>
            <mat-chip 
              [highlighted]="categoriaActiva() === 'personal'" 
              color="primary"
              (click)="filtrar('personal')">
              Personal
            </mat-chip>
            <mat-chip 
              [highlighted]="categoriaActiva() === 'trabajo'" 
              color="primary"
              (click)="filtrar('trabajo')">
              Trabajo
            </mat-chip>
            <mat-chip 
              [highlighted]="categoriaActiva() === 'familia'" 
              color="primary"
              (click)="filtrar('familia')">
              Familia
            </mat-chip>
          </mat-chip-set>
      </mat-card-content>
...
export class BuscadorContactosComponent {
  ...
  //! Se agregi esto 
  categoriaActiva = this.contactosService.categoriaSeleccionada;
  
  filtrar(categoria: string): void {
    this.contactosService.actualizarCategoria(categoria);
  }
  /**
