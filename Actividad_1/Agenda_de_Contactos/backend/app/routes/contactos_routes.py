...
from app.controllers.contactos_controller import (
    ...
    eliminar_contacto,
    buscar_contactos,
    obtener_contactos_por_categoria #! Se agrego esto
)
...
@router.get("/categoria/{categoria}", response_model=list[Contacto])#! Se agrego esto
def buscar_por_categoria(categoria: str): #! Se agrego esto
    """
    GET /contactos/categoria/trabajo

    Devuelve una lista de contactos que pertenecen 
    estrictamente a la categoría especificada.
    
    Categorías válidas: 'personal', 'trabajo', 'familia'.
    """
